...
final Map<String, Widget> tabs = {
  "file": const FileViewPage(isSolo: true),
...
class SoloStudyScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SoloStudyScreen> createState() => _RoomScreenState();
}

class _RoomScreenState extends ConsumerState<SoloStudyScreen>
